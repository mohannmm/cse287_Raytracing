...
1. In debug mode, this gives an error, and the error refers to an assertion to this->size()

2. glm::mat2x4 has 4 rows
...
int main(int argc, char *argv[]) {
	...
	std::cout << myinverse(M2x2A) << std::endl;
	std::cout << myinverse(M2x2B) << std::endl;
	std::cout << myinverse(M2x2C) << std::endl;
	
	// YOU CAN ADD MORE TESTS BELOW THIS LINE
	glm::mat2 mat;
	mat[0][0] = 2; mat[1][0] = 1;
	mat[0][1] = 4; mat[1][1] = -2;
