...
/**
 * @fn	BoundingBox::BoundingBox(float left, float right, float bottom, float top)
 * @brief	Constructs a bounding box with particular settings.
 * @param	left  	left.
 * @param	right 	right.
 * @param	bottom	bottom.
 * @param	top   	top.
...
BoundingBox::BoundingBox(float left, float right, float bottom, float top) {
	lx = left;
	rx = right;
	ly = bottom;
	ry = top;
...
/**
 * @fn	float BoundingBox::width() const
 * @brief	Returns the width of the BoundingBox
...
/**
* @fn	float BoundingBox::height() const
* @brief	Returns the height of the BoundingBox
...
/**
* @fn	float BoundingBox::aspectRatio() const
* @brief	Returns the aspectRatio of the BoundingBox
* @return	AspectRatio of BoundingBox.
*/

float BoundingBox::aspectRatio() const {
	return width() / height();
}
